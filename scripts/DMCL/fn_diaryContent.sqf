...
player createDiaryRecord [
	...
	["Server Parameters",
	format [
	"<br/><font color='#FDFFAB' size=20>Server Parameters</font><br/><br/><font color='#AFAFAF'>Mission Check Rate:</font> %2 Minutes<br/><font color='#AFAFAF'>Mission Chance:</font> %3%1<br/><font color='#AFAFAF'>Time Sensitive Enabled:</font> %4<br/><font color='#AFAFAF'>Time Sensitive Chance:</font> %5%1<br/><font color='#AFAFAF'>Min Building Garrison Size:</font> %6<br/><font color='#AFAFAF'>Max Mission Start Distance:</font> %7<br/><font color='#AFAFAF'>Min Mission Start Distance:</font> %8<br/><font color='#AFAFAF'>HVT Escape Radius:</font> %9 Metres<br/><font color='#AFAFAF'>Include Custom Cache Items:</font> %10<br/><font color='#AFAFAF'>Empty Cache Contents:</font> %11<br/><font color='#AFAFAF'>Mission Failure Penalties:</font> %12<br/><font color='#AFAFAF'>MFP Hostage Rescue:</font> %13<br/><font color='#AFAFAF'>MFP HVT:</font> %14<br/><font color='#AFAFAF'>MFP Cache:</font> %15<br/><font color='#AFAFAF'>Debug Mode:</font> %16<br/><font color='#AFAFAF'>HVT Debug Mode:</font> %17<br/><br/>
	<font color='#AFAFAF'>Parameters can be modified in fn_LMOinit.sqf</font>
	","%",LMO_mCheckRNG,LMO_mChanceSelect,LMO_TST,LMO_TSTchance,LMO_bSize,LMO_enyRng,LMO_bPlayerRng,LMO_HVTescRng,LMO_CacheItems,LMO_CacheEmpty,(LMO_Penalties select 0),(LMO_Penalties select 1),(LMO_Penalties select 2),(LMO_Penalties select 3),LMO_Debug,LMO_HVTDebug]
	],
	taskNull,
	"",
	false
...
player createDiaryRecord [
    ...
    <br/><br/><font color='#F49434' size=16>HVT Capture or Kill</font><br/>    <font color='#AFAFAF'>    Captured Armed:</font> <font color='#4DD74E'>+%5 Intelligence    -%6%1 Alert Level [ ! ]</font><br/>    <font color='#AFAFAF'>Captured Unarmed:</font> <font color='#4DD74E'>+%7 Intelligence    -%6%1 Alert Level [ ! ]</font><br/>    <font color='#AFAFAF'>Killed:</font> <font color='#4DD74E'>-%8%1 Alert Level [ ! ]</font><br/><br/><font color='#36FD9B' size=16>Destroy or Secure Cache</font><br/>    <font color='#AFAFAF'>Secured:</font> <font color='#4DD74E'>%9<br/></font>    <font color='#AFAFAF'>Destroyed:</font> <font color='#4DD74E'>%10<br/></font>    <font color='#AFAFAF'>Lost:</font> <font color='#ff0000'>%11<br/></font>
    ","%",LMO_HR_Win_CivRep, LMO_HR_Win_Intel, LMO_HR_Lose_CivRep, LMO_HVT_Win_intelUnarmed, LMO_HVT_Win_CapAlert, LMO_HVT_Win_intelArmed, LMO_HVT_Win_KillAlert, "TBD", LMO_Cache_Win_Rdy, LMO_Cache_Lose_Rdy]
    ],
    taskNull,
    "",
    false
